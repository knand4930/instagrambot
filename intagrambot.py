...
chromedriver_path = 'C:/Users/Nand Kishore/Downloads/Compressed/chromedriver_win32_2/chromedriver.exe'  # Change this to your own chromedriver path!
...
username.send_keys('zyme_in')
password = webdriver.find_element_by_name('password')
password.send_keys('Trignonivi@007')
...
notnow.click()
hashtag_list = ['software', 'gamedevelopment', 'game', 'love']
